void v_n_graphing_orig (int version = 0) {
  ...
  //Reset ROOT
   ...
   TFile *f0 = new TFile("e_n_fluctuations_MAGMA.root");
   ...
   hist_2->GetXaxis()->SetTitleSize(.045);
   hist_2->GetYaxis()->SetTitleSize(.045);
   hist_2->GetYaxis()->SetTitleOffset(5);
   hist_2->GetXaxis()->SetLabelSize(.045);
   hist_2->GetYaxis()->SetLabelSize(.045);  
   ...
   TGraph *e22 = (TGraph*) (f0->Get("e2_2_MAGMA"));
   TGraph *e24 = (TGraph*) (f0->Get("e2_4_MAGMA"));
   TGraph *e32 = (TGraph*) (f0->Get("e3_2_MAGMA"));

//Scale ecc by kappa to plot v_n fluctuations
...
//    //================================
   ...
   atlasv22->SetMarkerSize(0.75);
   atlasv24->SetMarkerSize(0.75);
   atlasv32->SetMarkerSize(0.75); 
   ...
   char footext[100];
   if (version == 0) sprintf(footext,"#font[62]{MAGMA PbPb [A #times B_{WS}+A_{WS}#times B]}");
   if (version == 1) sprintf(footext,"#font[62]{MAGMA PbPb [A #times B]}");
   TLegend *tleg = new TLegend(0.2,0.64,0.67,0.9,footext,"brNDC");
   ...
   sprintf(footext,"#font[62]{v_{2}{4}} = #varepsilon_{2}{4} #times (#kappa_{2} = %3.2f)",kappa2);
   tleg->AddEntry(e24,footext,"l");
   sprintf(footext,"#font[62]{v_{3}{2}} = #varepsilon_{3}{2} #times (#kappa_{3} = %3.2f)",kappa3);   
   tleg->AddEntry(e32,footext,"l");   
   tleg->AddEntry(atlasv22,"#font[62]{ATLAS data v_{2}{2}}, #font[62]{v_{2}{4}}, #font[62]{v_{3}{2}}","p");
   tleg->SetTextSize(.029);
   tleg->SetLineStyle(1);
   tleg->SetTextFont(62);
   tleg->Draw("same");   
