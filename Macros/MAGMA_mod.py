...
###############################################################################
    ...
    e_tot=np.sum(rho_mod)
    obs[ev,4]=e_tot
    obs[ev,5]=e_tot*area
    
    #Recentering correction 
    center_x=np.sum(rho_mod*x_grid)/e_tot
    center_y=np.sum(rho_mod*y_grid)/e_tot
...
gr_v2_2_mod = TGraph(n_bin - 1, centrality_coord, v2_2_coord)
gr_v2_4_mod = TGraph(n_bin - 1, centrality_coord, v2_4_coord)
gr_v3_2_mod = TGraph(n_bin - 1, centrality_coord, v3_2_coord)
gr_v2_over_v3_ratio_mod = TGraph(n_bin - 1, centrality_coord, ratio_v2_over_v3_coord)
gr_v3_over_v2_ratio_mod= TGraph(n_bin - 1, centrality_coord, ratio_v3_over_v2_coord)

v_n_MAGMA_mod = ROOT.TFile.Open('v_n_fluctuations_MAGMA_mod.root', 'RECREATE')

gr_v2_2_mod.Write('v2_2_MAGMA_mod')
gr_v2_4_mod.Write('v2_4_MAGMA_mod')
gr_v3_2_mod.Write('v3_2_MAGMA_mod')
gr_v2_over_v3_ratio_mod.Write('v2_over_v3_MAGMA_mod')
gr_v3_over_v2_ratio_mod.Write('v3_over_v2_MAGMA_mod')
